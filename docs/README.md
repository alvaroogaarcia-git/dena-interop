...
- [Fase 19 - PostgreSQL datos externos desde Markdown DENA](guias/fase19-datos-externos.md): base independiente con modelo semantico derivado de Markdown.
- [Fase 20 - NiFi hacia datos externos DENA](guias/fase20-nifi-datos-externos.md): sincronizacion incremental desde verticales al modelo DENA enriquecido.
